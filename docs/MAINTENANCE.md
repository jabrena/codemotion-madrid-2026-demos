...
take in account the internal and external interfaces:

- https://github.com/jabrena/latency-problems/blob/master/docs/problem1/god-api.yaml
- https://github.com/jabrena/latency-problems/blob/master/docs/problem1/my-json-server-oas.yaml
